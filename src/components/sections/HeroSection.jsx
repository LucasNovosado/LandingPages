          ...
          <div className={styles.content}>
            ...
            {storeData?.preco_inicial && (
              <div className={styles.priceBox}>
                <PriceTag price={storeData.preco_inicial} size="xl" showFrom={true} />
          ...
          <div className={styles.imageContainer}>
            {storeData?.imagem_produto ? (
              ...
              <div className={styles.productImage}>
                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="150" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
